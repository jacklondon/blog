    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/edit') && preg_match('#^/admin/edit/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'edit_content')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlogController::editContentAction',));
            }

            // delete_content
            if (0 === strpos($pathinfo, '/admin/delete') && preg_match('#^/admin/delete/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete_content')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\BlogController::deleteContentAction',));
            }
        ...
        // blog_post
        if (0 === strpos($pathinfo, '/content') && preg_match('#^/content/(?P<slug>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_post')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::content',));
        }
